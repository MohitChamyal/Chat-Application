...
const ProfilePage = () => {
  ...
  const handleSubmit = async(e) => {
    ...
    const reader = new FileReader(); // Fixed: render -> reader
      ...
      <div className='w-5/6 max-w-2xl backdrop-blur-2xl text-gray-300 border-2 border-gray-600 flex items-center justify-between max-sm:flex-col-reverse rounded-lg'>
        <form className='flex flex-col gap-5 p-10 flex-1' onSubmit={handleSubmit}>
          ...
          <input 
            ...
            className='p-2 border border-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-violet-500 bg-transparent text-white' // Fixed: class names
          />
          <textarea
